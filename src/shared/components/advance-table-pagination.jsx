 ...
 * narrows the currently-loaded page further than the server total says.
 * This component used to prefer `pagination.totalCount` unconditionally
 * whenever paginated, which went stale the moment a client-only filter
 * narrowed the table below that number (fixed 2026-09-17, alongside the
 * same fix for PowerSearch's own `resultCount` badge — both read from the
 * same resolved value now, so they can't disagree with each other).
