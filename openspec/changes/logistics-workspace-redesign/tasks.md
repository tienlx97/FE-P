...
- [x] 4.2 Tối ưu cột mặc định/chế độ xem tài chính, hành động bản ghi và chi tiết khách hàng; giữ filter/pagination/column preferences. Verify: dữ liệu dài, không có dữ liệu, cuộn bảng, mở/đóng chi tiết không reset danh sách.
